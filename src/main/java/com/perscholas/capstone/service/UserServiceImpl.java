...
public class UserServiceImpl implements IUserService {
    ...
    public UserDetails loadUserByUsername(String userName) {
        ...
        log.warn("--" + userName + "- loadUserByUsername(): Invalid username or password {}", userName);
